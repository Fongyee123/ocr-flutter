...
class EasyOCRScreen extends StatefulWidget {
  @override
  _EasyOCRScreenState createState() => _EasyOCRScreenState();
}

class _EasyOCRScreenState extends State<EasyOCRScreen> {
  File? _image;
  String _ocrText = '';
  ...
  Future<void> _uploadImage() async {
    ...
    try {
      final uri = Uri.parse('http://192.168.1.16:5001/easy-ocr'); // <-- YOUR IP ADDRESS
